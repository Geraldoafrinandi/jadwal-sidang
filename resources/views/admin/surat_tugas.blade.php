...
<body>
    ...
    <div class="badan">
        ...
        <table class="isi">
            ...
            <tbody >
                <tr class="table-light">
                    ...
                    <td class="nama_dosen">{{ $mhsPkl->dosenPembimbing->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsPkl->dosenPembimbing->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Dosen Pembimbing</td>
                </tr>

                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsPkl->dosenPenguji->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsPkl->dosenPenguji->nidn ?? 'Tidak ada Nip' }}</td>
        ...
        <div style="margin-bottom: 1%;">
            <font style="font-size: 15px;">Untuk melaksanakan Sidang PKL bagi mahasiswa berikut:</font>
        </div>
        <br>
        ...
        <table class="details-table">
            <tr>
                ...
                <td class="value">: {{ $mhsPkl->usulanPkl->mahasiswa->nama ?? 'Tidak ada Data' }}</td>
            </tr>
            <tr>
                <td class="label">NIM</td>
                <td class="value">: {{ $mhsPkl->usulanPkl->mahasiswa->nim ?? 'Tidak ada Data' }}</td>
            </tr>
            <tr>
                <td class="label">Tempat PKL</td>
                <td class="value">: {{ $mhsPkl->usulanPkl->tempatPkl->nama_perusahaan }}</td>
            </tr>
        </table>
    </div>
    ...
    <table class="isi">
        ...
        <tbody>
            <tr class="table-light">
                <td class="hari">
                    {{ \Carbon\Carbon::parse($mhsPkl->tgl_sidang)->locale('id')->translatedFormat('l') }}
                </td>
                <td class="tanggal_sidang">
                    {{ \Carbon\Carbon::parse($mhsPkl->tgl_sidang)->format('d-m-Y') }}</td>
                <td class="jam">{{ $mhsPkl->sesi->jam ?? 'Tidak ada data' }}</td>
                <td class="ruangan">{{ $mhsPkl->ruang->ruangan ?? 'Tidak ada data' }}</td>
            </tr>
        </tbody>
    </table>
    <br>
