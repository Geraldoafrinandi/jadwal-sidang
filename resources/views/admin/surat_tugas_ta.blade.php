...
<body>
    ...
    <div class="badan">
        ...
        <table class="isi">
            ...
            <tbody >
                <tr class="table-light">
                    ...
                    <td class="nama_dosen">{{ $mhsTa->r_pembimbing_satu->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_pembimbing_satu->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Dosen Pembimbing 1</td>
                </tr>
                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsTa->r_pembimbing_dua->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_pembimbing_satu->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Dosen Pembimbing 2</td>
                </tr>
                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsTa->r_ketua->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_pembimbing_satu->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Ketua Sidang</td>
                </tr>
                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsTa->r_sekretaris->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_sekretaris->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Sekretaris</td>
                </tr>

                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsTa->r_penguji_1->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_penguji_1->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Dosen Penguji 2</td>
                </tr>

                <tr class="table-light">
                    <td class="no">{{ $counter++ }}</td>
                    <td class="nama_dosen">{{ $mhsTa->r_penguji_2->nama_dosen ?? 'Tidak ada Dosen' }}</td>
                    <td class="nip">{{ $mhsTa->r_penguji_2->nidn ?? 'Tidak ada Nip' }}</td>
                    <td class="jabatan">Dosen Penguji 2</td>
                </tr>
        ...
        <table class="details-table">
            <tr>
                ...
                <td class="value">: {{ $mhsTa->r_mhs_sempro->r_mahasiswa->nama ?? 'Tidak ada Data' }}</td>
            </tr>
            <tr>
                <td class="label">NIM</td>
                <td class="value">: {{ $mhsTa->r_mhs_sempro->r_mahasiswa->nim ?? 'Tidak ada Data' }}</td>
            </tr>
        </table>
    </div>
    ...
    <table class="isi">
        ...
        <tbody>
            <tr class="table-light">
                <td class="hari">
                    {{ \Carbon\Carbon::parse($mhsTa->tanggal_ta)->locale('id')->translatedFormat('l') }}
                </td>
                <td class="tanggal_sidang">
                    {{ \Carbon\Carbon::parse($mhsTa->tanggal_ta)->format('d-m-Y') }}</td>
                <td class="jam">{{ $mhsTa->r_sesi->jam ?? 'Tidak ada data' }}</td>
                <td class="ruangan">{{ $mhsTa->r_ruangan->ruangan ?? 'Tidak ada data' }}</td>
            </tr>
        </tbody>
    </table>
    <br>
    ...
    <div class="signatures">
        <table style="width: 100%;">
            <tr>
                <td class="right" style="padding-left: 100px; margin-bottom: 1100px">
