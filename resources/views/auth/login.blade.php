    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            width: 100%;
            place-items: center;
            background: -webkit-linear-gradient(left,  #146C94, #7eb2e0, #146C94);
        }
                ...
                <div class="form-container">
                    ...
                    <div class="form-inner">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="login">
                            ...
                            <div class="pass-link"><a href="#" data-bs-toggle="modal" data-bs-target="#forgotPasswordModal">Forgot password?</a></div>
                            <div class="field btn">
